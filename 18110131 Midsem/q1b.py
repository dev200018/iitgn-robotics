...
if __name__=="__main__":
    ...
    corners=[]
    for i in range(4):
        print("Input coordinates(in metres) for corner "+chr(65+i)+" :\n")
        xyz=[]
        for j in range(3):
            print(" Value of "+chr(88+j)+": ")
            userInput=float(str(input()))
            xyz.append(userInput)
        P=np.array([[xyz[0]],[xyz[1]],[xyz[2]],[1]])
        corners.append(P)
